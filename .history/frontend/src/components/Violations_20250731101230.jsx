...
const API_BASE_URL = 'https://mzhyi8cnjd0y.manus.space';
...
const Violations = () => {
  ...
  const handleDelete = async (violationId) => {
    if (window.confirm('Tem certeza que deseja excluir esta violação?')) {
      try {
        const response = await fetch(`${API_BASE_URL}/api/violations/${violationId}`, {
          method: 'DELETE'
        })
        if (response.ok) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch(`${API_BASE_URL}/api/violations/${editingViolation.id}`, {
        method: 'PUT',
        headers: {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold text-gray-900">Violações</h2>
          <p className="text-gray-600">Gerencie violações e infrações do condomínio</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Total de Violações</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Violações Abertas</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Violações Resolvidas</p>
